    ...
    <>
      ...
      {showPaymentModal && orderResult && (
        <PaymentModal
          ...
          amount={orderResult.totalAmount || paymentAmount}
          expiresAt={orderResult.paymentLinkExpiredAt}
                    ...
                    {!user && (
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setCustomerInfo({ ...customerInfo, verificationPass: e.target.value })
                          }
                ...
                <div className="bg-white rounded-xl shadow-sm p-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="flex-1 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
                    >
                      {loading ? (
                        <>
              ...
              {step === 'confirmation' && (
                <div className="bg-white rounded-xl shadow-sm p-6 text-center">
                  ...
                  <div className="text-left mb-8">
                    <h3 className="font-semibold mb-4 text-gray-900">Quy trình tiếp theo</h3>
                    <div className="space-y-4">
                      {[
                        ...
                        {
                          num: 4,
                          title: isDeposit ? 'Thanh toán & nhận QR code kích hoạt' : 'Nhận QR code kích hoạt',
                          sub: isDeposit
                        ...
                        <div key={s.num} className="flex items-start gap-3">
                          <div
                            className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 text-sm font-medium ${
                              s.num === 1 ? 'bg-green-600 text-white' : 'bg-gray-200 text-gray-600'
                            }`}
                          >
                            {s.num === 1 ? <Check size={16} /> : s.num}
                          </div>
                          <div>
                            <div className="font-medium text-gray-900 mb-0.5">{s.title}</div>
